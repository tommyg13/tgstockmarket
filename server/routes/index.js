...
router.post("/addNew",(req,res)=>{
    ...
    if(!stock) {
     ...
     axios.get(`https://www.quandl.com/api/v3/datasets/WIKI/${stock}.json?column_index=4&start_date=2015-01-01&end_date=${formattedDate}"&api_key=${process.env.QUANDL_KEY}`)
          .then(response=>{
